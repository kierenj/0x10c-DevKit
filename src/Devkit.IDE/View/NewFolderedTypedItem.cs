...
{
	public class NewFolderedTypedItem : InfoRequestViewBase<NewFolderedTypedItemInfo>, IComponentConnector
	{
		...
		public void InitializeComponent()
		{
			...
			try
			{
				if (!this._contentLoaded)
				{
					...
					uri = new Uri("/Devkit.IDE;component/view/newfolderedtypeditem.xaml", UriKind.Relative);
